...
function EMustContainUppercase(value) {
  ...
  Error.captureStackTrace(this, EMustContainUppercase);

  this.message = t.t(
    'The value ":value" must contain at least 1 uppercase character.',
    {':value': value}
  );
}
 ...
 */
util.inherits(EMustContainUppercase, Error);
